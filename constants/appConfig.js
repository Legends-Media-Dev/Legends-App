/**
 * App-specific config the customer can adjust.
 * Change the featured collection handle and labels without touching screen code.
 */
...
export const HOME_FEATURED_COLLECTION = {
  ...
  subtitle: "Fresh picks, updated often",
};
